...
const productsService = {
  ...
  updateProduct(id, product) {
    ...
    return axios
      .put(`${BASE_URL}/update/${id}`, product)
      .then((response) => {
  ...
  findProductByCategoryId(categoryId) {
    ...
    return axios
      ...
      .catch((error) => {
        console.error(
          `Error fetching products with category ID ${categoryId}:`,
          error,
        );
        throw error;
      });
  ...
  findProductByStockQuantity(stockQuantity) {
    ...
    return axios
      .get(`${BASE_URL}/stock`, { params: { stockQuantity } })
      .then((response) => {
        console.log(
          "Products fetched successfully by stock quantity:",
          response.data,
        );
        return response;
      })
      .catch((error) => {
        console.error(
          `Error fetching products with stock quantity ${stockQuantity}:`,
          error,
        );
        throw error;
      });
  ...
  findProductCreatedAfter(date) {
    ...
    return axios
      .get(`${BASE_URL}/created-after`, { params: { createdAt: date } })
      .then((response) => {
        console.log(
          "Products fetched successfully created after:",
          response.data,
        );
        return response;
      })
  ...
  findProductUpdatedBefore(date) {
    ...
    return axios
      .get(`${BASE_URL}/updated-before`, { params: { updatedAt: date } })
      .then((response) => {
        console.log(
          "Products fetched successfully updated before:",
          response.data,
        );
        return response;
      })
  ...
  findProductByPriceRange(minPrice, maxPrice) {
    console.log(
      `Finding products within price range: ${minPrice} - ${maxPrice}`,
    );
    return axios
      .get(`${BASE_URL}/price`, { params: { minPrice, maxPrice } })
      .then((response) => {
        console.log(
          "Products fetched successfully within price range:",
          response.data,
        );
        return response;
      })
      .catch((error) => {
        console.error(
          `Error fetching products within price range ${minPrice} - ${maxPrice}:`,
          error,
        );
        throw error;
      });
