...
const wishlistService = {
  ...
  createWishlist(wishlist) {
    ...
    return axios.post(`${BASE_URL}/create`, wishlist)
      .then(response => {
  ...
  updateWishlist(id, wishlist) {
    ...
    return axios.put(`${BASE_URL}/update/${id}`, wishlist)
      .then(response => {
  ...
  deleteWishlist(id) {
    ...
    return axios.delete(`${BASE_URL}/delete/${id}`)
      ...
      .catch(error => {
        console.error(`Error deleting wishlist with ID ${id}:`, error.response || error.message || error);
        throw error;
      });
  },
  ...
  getWishlistsByUserId(userId) {
    ...
    return axios.get(`${BASE_URL}/user/${userId}`)
      .then(response => {
        console.log(`Retrieved wishlists for user ID ${userId}:`, response.data);
        return response.data;
      })
      .catch(error => {
