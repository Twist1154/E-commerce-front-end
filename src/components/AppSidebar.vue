  ...
  <div>
    ...
    >
      <v-list>
        ...
        <v-list-item>
          <v-list-item-avatar>
            <v-img :src="userAvatar" alt="User  Avatar" class="user-avatar" />
          </v-list-item-avatar>
          <v-list-item-content>
        ...
        <v-spacer></v-spacer>
        <!-- Pushes logout/login button to the bottom -->
...
export default {
  ...
  computed: {
    userAvatar() {
      return (
        this.authStore.getCurrentUser?.avatar ||
        "https://www.google.com/url?sa=i&url=https%3A%2F%2Fuxwing.com%2Fno-profile-picture-icon%2F&psig=AOvVaw297_euzi07Wz5Q2_wDyCNM&ust=1729074362807000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCKir9ZKWkIkDFQAAAAAdAAAAABAE"
      );
    },
    username() {
